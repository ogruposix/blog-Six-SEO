...
const HomeCoverSection = ({ blogs }) => {
  ...
  return (
    <div className="w-full inline-block mt-16 md:mt-20">
      <article className="flex flex-col items-start justify-end mx-5 sm:mx-10 relative h-[60vh] sm:h-[85vh]">
        ...
        <div className="w-full lg:w-3/4 p-6 sm:p-8 md:p-12 lg:p-16 flex flex-col items-start justify-center z-0 text-lightText">
